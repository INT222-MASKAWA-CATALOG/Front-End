...
export default {
	...
	data() {
		return {
			brandlink: "http://172.18.0.3:3000/brand",
			brands: [],
			colorlink: "http://172.18.0.3:3000/color",
			colors: [],
			addProductDataLink: "http://172.18.0.3:3000/addProduct",
			uploadImageLink: "http://172.18.0.3:3000/uploadImage",
